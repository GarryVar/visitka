    ...
    render () {
        return (
            <div className="content">
                ...
                <section className={style.text}>Это моя визитка здесь можно ознакомится с моими навыками веб - разработки, увлечениями, интересами. Здесь я  собрал всё чем увлекаюсь. От написания кода, до рисования svg иконок и написания музыки. Это стандартное реакт приложение, в стадии разработки и дополнения. Оно будет дорабатываться по мере изучения этого фреймворка…</section>
